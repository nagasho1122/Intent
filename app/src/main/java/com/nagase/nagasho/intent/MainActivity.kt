package com.nagase.nagasho.intent
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapButton.setOnClickListener {
            ...
            if (mapIntent.resolveActivity(packageManager) != null){ //対応するアプリがあるか確認
        ...
        browserButton.setOnClickListener {
            ...
            if (browserIntent.resolveActivity(packageManager) != null){ //対応するアプリがあるか確認
                startActivity(browserIntent)
            }
        }
        galleryButton.setOnClickListener {
            val galleryIntent = Intent(Intent.ACTION_OPEN_DOCUMENT) //別のアプリが管理しているファイルを取得できるようになる
